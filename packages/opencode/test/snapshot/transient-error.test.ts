...
describe("isTransientGitError", () => {
  const cases: Array<[string, boolean]> = [
    ...
    ["Not enough storage is available to process this command", true],
    ["Not enough memory resources are available to process this command", true],
    ["fatal: insufficient memory", true],
